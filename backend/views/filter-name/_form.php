...
<div class="filter-name-form">
    ...
    <?= $form->field($model, 'display_for_screen_page')->dropDownList(['0' => 'None', '1' => 'Dropdown - ID1', '2' => 'Chcekbox - ID2', '3' => 'Textbox - Numbers- ID3', '4' => 'Textbox - Value - ID4', '5' => 'Range - ID5'], ['onchange'=>'custom_validation()']);  ?>
