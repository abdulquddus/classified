...
<!--                               <div class="col-md-2">
                ...
                <?php } ?>
<!--                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="1"  class="rdo_main">Buy 100 Krb Pay NOK  95</li>
                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="2"  class="rdo_main">Buy 200 Krb Pay NOK  180</li>
                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="3"  class="rdo_main">Buy 500 Krb Pay NOK  425</li>
                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="4"  class="rdo_main">Buy 1000 Krb Pay NOK 800</li>
                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="5"  class="rdo_main">Buy 2000 Krb Pay NOK  1500</li>
                            <li><input id="radio" type="radio" name="package" onclick="set_credit(this)" value="6"  class="rdo_main">Buy 15000 Krb Pay NOK  3500</li>-->
